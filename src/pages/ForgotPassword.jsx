  ...
  return (
    <section>
      ...
      <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
        <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=773&q=80" alt="Sample key" className='w-full rounded-2xl'/>
      </div>
      ...
      <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
        ...
        <div className='flex item-center my-4 before:border-t before:flex-1 before:border-gray-300 after:border-t after:flex-1 after:border-gray-300'>
